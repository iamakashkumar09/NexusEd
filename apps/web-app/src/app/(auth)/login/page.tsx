...
function Field({ label, error, children }: { label: string; error?: string; children: React.ReactNode }) {
  return (
    <div style={{ marginBottom: 16 }}>
      <label style={{ display: 'block', fontSize: 13, fontWeight: 600, color: 'var(--ink-muted)', marginBottom: 6, letterSpacing: '-0.01em' }}>
        {label}
      </label>
      {children}
    ...
    <div>
      ...
      <div style={{ marginBottom: 32 }}>
        ...
        <p style={{ fontSize: 14, color: 'var(--ink-subtle)' }}>
          Sign in to your NexusEd account
        </p>
      </div>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '20px 0' }}>
        ...
        <span style={{ fontSize: 12, color: 'var(--ink-ghost)', fontWeight: 500 }}>or continue with</span>
        <div style={{ flex: 1, height: 1, background: 'var(--hairline)' }} />
      </div>
      ...
      <button style={{
        ...
        borderRadius: 'var(--r-md)', border: '1px solid var(--hairline-strong)',
